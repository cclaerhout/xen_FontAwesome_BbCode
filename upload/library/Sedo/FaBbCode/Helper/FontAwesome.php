...
class Sedo_FaBbCode_Helper_FontAwesome
{
	public static function getFonts()
	{
		if(class_exists('BBM_Helper_FontAwesome'))
		{
			return BBM_Helper_FontAwesome::getFonts();
		}
	...
	public static function getFontCode($fontName)
	{	
		$fontsList = self::getFonts();
		
		if(!isset($fontsList[$fontName]))
		{
			return false;
		}
		
		return $fontsList[$fontName];
	}

	public static function checkFontOption($option, $includeFontSize = true)
	{
		$fontOptions = self::getFontOptions();
		
		if(!in_array($option, $fontOptions))
		{
			return false;
		}
		
		if(!$includeFontSize && in_array($option, array('fa-lg', 'fa-2x', 'fa-3x', 'fa-4x', 'fa-5x')))
		{
			return false;
		}
	...
	public static function checkFontSize($option)
	{
		if(!in_array($option, array('fa-lg', 'fa-2x', 'fa-3x', 'fa-4x', 'fa-5x')))
		{
			return false;
		}
